...
bool CsvParser::ProcessHeader( const QStringList& hdr, const QStringList& data )
{
   ...
   // Create a description table containing the header and data information.
	sQuery = "CREATE TABLE Columns (ID INTEGER PRIMARY KEY AUTOINCREMENT, FriendlyName VARCHAR(32), Type VARCHAR(16))";
